...
def choosing_the_game_option(BOX_SIZE, NUMBER_OF_SET_BOXES, WIN_OR_LOST):
    ...
    while b >= 0:
        ...
        for click in clicks:
            ...
            if click.x  > 95 and click.x < 245 and click.y > 360 and click.y < 470:
            ...
            elif click.x  > 355 and click.x < 505 and click.y > 360 and click.y < 470:
...
if __name__ == "__main__":
    canvas.set_canvas_title("Nonogram")
    main()
    print("Finish")
